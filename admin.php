					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a>Kelompok 2KA09 :</a><br>Arya Seno<br>Ami Wulandari<br>Zaidan Rivandani<br>Zitta Syabillah<br></div>
							</div>
						</div>
