		...
		<body>
			<div id="header">
				<div>
					...
					<div class="inlinecenterblock">
						<h1 style="margin: 0px; font-size: 45px; color: <?php echo $maincolor ?>; font-weight: bold;"><a href="<?php echo $baseurl ?>"><?php echo $websitetitle ?></a></h1>
			...
			<script>
				...
				function showcartui(){
					...
					cartdata += "<label><?php echo uilang("Mobile Number") ?></label><input id='cdmobile' type='number' placeholder='<?php echo uilang("Mobile Number") ?>'>"
					cartdata += "<label><?php echo uilang("Email Address") ?></label><input id='cdaddress' placeholder='<?php echo uilang("Email Address") ?>'>"
					cartdata += "<label><?php echo uilang("Delivery Method") ?></label><select id='cdmethod'><?php echo uilang("Delivery Method") ?><option>Direct</option><option>Email</option></select>"
